...
public class Main {
	public static void main(String[] args) {
		...
		Timeclient p_1 = new Timeclient(new Clock("1", incrementTime, 0.07),
				p1_addr, "P1");
		Timeserver p_2 = new Timeserver(new Clock("2", incrementTime, 0.00),
				p2_addr);
		Timeclient p_3 = new Timeclient(new Clock("3", incrementTime, 0.15),
				p3_addr, "P3");
		Timeclient p_4 = new Timeclient(new Clock("4", incrementTime, -0.10),
				p4_addr, "P4");
